...
/*   Updated: 2024/01/29 15:08:53 by ekrause          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		g_game.image_player.image_character2->instances[0].y -= 8;
// 		g_game.image_player.image_character3->instances[0].y -= 8;
// 		g_game.image_player.image_character4->instances[0].y -= 8;
// 		g_game.image_player.image_character5->instances[0].y -= 8;
// 	}
...
// void	update_tree(mlx_t *mlx)
// {
// 	if (g_animation == 1)
// 	{
// 		g_game.image_player.image_character5->instances[0].enabled = false;
// 		g_game.image_player.image_character->instances[0].enabled = true;
// 	}
// 	else if (g_animation == 2)
// 	{
// 		g_game.image_player.image_character->instances[0].enabled = false;
// 		g_game.image_player.image_character2->instances[0].enabled = true;
// 	}
// 	else if (g_animation == 3)
// 	{
// 		g_game.image_player.image_character2->instances[0].enabled = false;
// 		g_game.image_player.image_character3->instances[0].enabled = true;
// 	}
// 	else if (g_animation == 4)
// 	{
// 		g_game.image_player.image_character3->instances[0].enabled = false;
// 		g_game.image_player.image_character4->instances[0].enabled = true;
// 	}
// 	else if (g_animation == 5)
// 	{
// 		g_game.image_player.image_character4->instances[0].enabled = false;
// 		g_game.image_player.image_character5->instances[0].enabled = true;
// 		g_animation = 0;
// 	}
