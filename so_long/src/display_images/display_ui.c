...
/*   Updated: 2024/02/12 15:29:24 by ekrause          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_ui(mlx_t *mlx, t_game *game)
{
	...
	mlx_image_to_window(mlx, game->image_ui.image_win, \
	(win_width - win_width / 2) - (img_width / 2), \
	(win_height - win_height / 2) - (img_height / 2));
	mlx_image_to_window(mlx, game->image_ui.image_lose, \
	(win_width - win_width / 2) - (img_width / 2), \
	(win_height - win_height / 2) - (img_height / 2));
